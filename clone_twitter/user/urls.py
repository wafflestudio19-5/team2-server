...
from user.views import PingPongView, EmailSignUpView, UserLoginView, UserFollowView, UserUnfollowView, FollowListViewSet

router = SimpleRouter()
router.register('follow_list', FollowListViewSet, basename='follow_list')  # /api/v1/user/
